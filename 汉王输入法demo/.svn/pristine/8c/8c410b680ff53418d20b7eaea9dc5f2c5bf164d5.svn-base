...
//static int FLAG_BRIGHTNESS_SLIDER_KNOB = 0X0000;
static int FLAG_ALPHA_SLIDER_KNOB = 0X1111;
float fitHeight = 0;//fit 4s 5 5s 6 6plus pad
...
- (id)initWithFrame:(CGRect)frame Flag:(int)flag
{
    ...
    if (self) 
    {
        ...
        if (flag != FLAG_ALPHA_SLIDER_KNOB) {
